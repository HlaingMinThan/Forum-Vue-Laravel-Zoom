                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex-1">
                        ...
                        >
                            <span
                                >Posted by
                                {{ thread.user?.name || "Anonymous" }}</span
                            >
                            <span>•</span>
            ...
            <div class="mt-6">
                ...
                >
                    ...
                    <div class="mt-4 flex items-start space-x-4">
                        <div class="flex-shrink-0">
                            <div
                                class="w-10 h-10 rounded-full bg-gradient-to-br from-indigo-500 to-sky-500 text-white flex items-center justify-center font-semibold"
                            >
                                U
                            </div>
                        </div>
                            ...
                            <div class="relative">
                                ...
                                >
                                    ...
                                    <div class="space-x-2">
                                        <button
                                            type="button"
                                            class="inline-flex items-center px-3 py-2 rounded-md border border-gray-300 text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                                        >
                                            Cancel
                                        </button>
                                        <button
                        ...
                        <div class="flex items-start space-x-4">
                            <div class="flex-shrink-0">
                                <Link
                                    ...
                                    class="w-10 h-10 rounded-full bg-gray-200 text-gray-700 flex items-center justify-center font-semibold"
                                >
                                    {{
                                        comment.user.name
                                            .charAt(0)
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <div class="mt-3 text-gray-800 leading-relaxed">
                                    ...
                                    <div
                                        v-else
                                        class="whitespace-pre-wrap prose"
                                    >
                                ...
                                >
                                    <button
                                        class="inline-flex items-center space-x-1 hover:text-gray-900"
                                    >
                                        <svg
                                            class="w-4 h-4"
                                            fill="none"
                                    ...
                                    <template v-if="editingId === comment.id">
                                        ...
                                        <button
                                            ...
                                            class="inline-flex items-center space-x-1 text-blue-600 hover:text-blue-700 disabled:opacity-50"
                                        >
                                            <svg
                                                class="w-4 h-4"
                                                fill="none"
                                    ...
                                    <button
                                        v-else-if="
                                            comment.commentActionAuthorize
                                        "
                                    ...
                                    >
                                        <button
                                            type="submit"
                                            class="inline-flex items-center space-x-1 text-red-500 hover:text-gray-900"
                                        >
                                            <span>delete</span>
                                        </button>
                                    </Form>
...
import { Link, usePoll, Form, router, usePage } from "@inertiajs/vue3";
...
const saveComment = async () => {
    await router.post(
        `/threads/${props.thread.id}/comments/store`,
        {
...
watch(
    () => page.props.value?.auth?.user ?? null,
    (newUser) => {
        if (!newUser) liked.value = false;
        else liked.value = props.initialLiked;
    }
);

function buildLikeUrl(action = "like") {
    if (typeof window.route === "function") {
        return action === "like"
            ? window.route("threads.likes.like", props.thread.id)
            : window.route("threads.likes.unlike", props.thread.id);
    }
    return `/threads/${props.thread.id}/likes`;
}
...
async function toggleLike() {
    ...
    try {
        ...
        // console.log("Before:", previous, "After:", liked.value);
    }
}
</script>
