<template>
    <div class="min-h-screen bg-gray-50">
        <!-- Top cover / banner -->
        <div
            class="h-40 w-full bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600"
        ></div>
            ...
            <div class="bg-white rounded-xl shadow-sm border p-6">
                ...
                >
                    <div class="flex items-start gap-4">
                        <div
                            class="w-24 h-24 rounded-xl bg-gradient-to-br from-indigo-500 to-blue-500 text-white flex items-center justify-center text-3xl font-semibold shadow"
                        >
                        ...
                        <div>
                            ...
                            <div
                                class="mt-3 flex flex-wrap items-center gap-3 text-sm text-gray-600"
                            >
                                ...
                                <span class="inline-flex items-center gap-1">
                                    ...
                                    >
                                        <path
                                            ...
                                            stroke-linejoin="round"
                                            stroke-width="2"
                                            d="M17.657 16.657L13.414 12.414a4 4 0 10-5.657 5.657l4.243 4.243a8 8 0 111.657-1.657z"
                                        />
                                    </svg>
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <Form
                            :action="`/handle-follow/${user?.id}`"
                            method="POST"
                        >
                            <button
                                v-if="!already_followed"
                                type="submit"
                            ...
                            <div class="flex items-center gap-3 text-gray-700">
                                ...
                                >
                                    <path
                                        ...
                                        stroke-linejoin="round"
                                        stroke-width="2"
                                        d="M3 7l9-4 9 4-9 4-9-4zm0 8l9 4 9-4"
                                    />
                                </svg>
                                <span>{{
                            ...
                            >
                                ...
                                >
                                    ...
                                    <a
                                        ...
                                        class="shrink-0 inline-flex items-center px-3 py-1.5 rounded-md text-xs font-medium bg-blue-50 text-blue-700 hover:bg-blue-100"
                                        >View</a
                                    >
                                </div>
                            </li>
